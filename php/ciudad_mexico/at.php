...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$imgC) {
        ...
        $sql = "UPDATE ciudad_mexico SET nombre=?, descripcion=?, ubicacion=?, costo_viaje=?, foto=? WHERE id=?";
        ...
        // Preparar la consulta SQL
        $sql = "UPDATE ciudad_mexico SET nombre=?, descripcion=?, ubicacion=?, costo_viaje=? WHERE id=?";
        $declaracion = $conexion->prepare($sql);
